      ...
      <IonContent fullscreen>
        <div key={product.id} className={styles.mainContainer}>
          ...
          <div className={styles.headerContainer}>
            <img src={require(`../../Images/${product.img}`)} alt="image" />
            <div className={styles.header__gradient}>
              <div className={styles.header__titleContainer}>
                <IonText id={styles.header__title}>{product.title}</IonText>
          ...
          <IonCard>
            <IonCardHeader>
              <IonCardTitle color="secondary">
                <h1>
                  {product.title} is succesvol toegevoegd aan je Winkelmandje
                </h1>
              </IonCardTitle>
            </IonCardHeader>
            <IonButton
