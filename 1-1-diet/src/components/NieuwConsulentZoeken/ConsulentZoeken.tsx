                  ...
                  <div className={styles.mainPopupContainer}>
                    ...
                    <div className={styles.aboutMe}>
                      ...
                      <IonText>
                        ...
                        elit. Cupiditate earum nemo impedit iusto aliquid ipsam
                        hic repudiandae incidunt facilis necessitatibus quidem,
                        enim vitae, distinctio nulla nesciunt. Totam ratione
                        itaque ad!
                      </IonText>
                    </div>
                    <div className={styles.openTime}>
